    ...
    <>
      ...
      <TripStop id="Nemecko" title="Německo Garmisch-Partenkirchen" color={false}>
        <div className="stop__text-picture">
          <img className="stop__img stop__img--left" src={`${import.meta.env.BASE_URL}images/Clip2Comic-Garmisch.jpeg`} alt="Německo Garmisch-Partenkirchen" />
      ...
      <TripStop id="Rakousko" title="Rakousko Prutz" color={true}>
        <div className="stop__text-picture">
          <img className="stop__img stop__img--right" src={`${import.meta.env.BASE_URL}images/Clip2Comic-Prutz.jpeg`} alt="Rakousko" />
      ...
      <TripStop id="Alsasko" title="Alsasko Wattwiller" color={true}>
        <div className="stop__text-picture">
          <img className="stop__img stop__img--left" src={`${import.meta.env.BASE_URL}images/Clip2Comic-Wattwiller.jpeg`} alt="Alsasko" />
      ...
      <TripStop id="CentralFrancie" title="Ounans - La Plage Blanche" color={false}>
        <div className="stop__text-picture">
          <img className="stop__img stop__img--right" src={`${import.meta.env.BASE_URL}images/Clip2Comic-LaPlageBlanche.jpeg`} alt="Centrální Francie" />
      ...
      <TripStop id="Andryes" title="Andryes - USHUAÏA Villages Au Bois Joli" color={true}>
        <div className="stop__text-picture">
          <img className="stop__img stop__img--left" src={`${import.meta.env.BASE_URL}images/Clip2Comic-LeBoisJoli.jpeg`} alt="Andryes - USHUAÏA Villages Au Bois Joli" />
      ...
      <TripStop id="Paris" title="Paříž - Versailles" color={false}>
        <div className="stop__text-picture">
          <img className="stop__img stop__img--right" src={`${import.meta.env.BASE_URL}images/Clip2Comic-Versailles.jpeg`} alt="Paříž" />
      ...
      <TripStop id="Disneyland" title="Paříž - Disneyland" color={false}>
        <div className="stop__text-picture">
          <img className="stop__img stop__img--left" src={`${import.meta.env.BASE_URL}images/Clip2Comic-Disneyland.png`} alt="Disneyland" />
      ...
      <TripStop id="TroyesMetz" title="Troyes & Metz" color={true}>
        <div className="stop__text-picture">
          <img className="stop__img stop__img--right" src={`${import.meta.env.BASE_URL}images/Clip2Comic-Troyes.jpeg`} alt="Troyes & Metz" />

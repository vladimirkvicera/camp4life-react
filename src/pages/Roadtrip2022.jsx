    ...
    <>
      ...
      <TripStop id="Auvergne" title="Auvergne - Clermont-Ferrand" color={false}>
        <div className="stop__text-picture">
          <img className="stop__img stop__img--left" src={`${import.meta.env.BASE_URL}images/Clip2Comic-Clermont.jpeg`} alt="Zastávka 1" />
      ...
      <TripStop id="DunePyla" title="Dune du Pilat" color={true}>
        <div className="stop__text-picture">
          <img className="stop__img stop__img--left" src={`${import.meta.env.BASE_URL}images/Clip2Comic-DunePilat2.jpeg`} alt="Dune Pyla 2" />
          <img className="stop__img stop__img--right" src={`${import.meta.env.BASE_URL}images/Clip2Comic-DunePilat.jpeg`} alt="Dune Pyla" />
      ...
      <TripStop id="LeGrandCrohot" title="Le Grand Crohot" color={false}>
        <div className="stop__text-picture">
          <img className="stop__img stop__img--left" style={{maxWidth: '320px'}} src={`${import.meta.env.BASE_URL}images/Clip2Comic-Bremontier-breakfast.jpeg`} alt="Le Grand Crohot" />
      ...
      <TripStop id="SoulacSurMer" title="Soulac-sur-Mer" color={true}>
        <div className="stop__text-picture">
          <img className="stop__img stop__img--right" src={`${import.meta.env.BASE_URL}images/Clip2Comic-Bremontier.jpeg`} alt="Soulac-sur-Mer" />
      ...
      <TripStop id="IleOleron" title="Ile d'Oléron" color={false}>
        <div className="stop__text-picture">
          <img className="stop__img stop__img--left" src={`${import.meta.env.BASE_URL}images/Clip2Comic-Oleron2.jpeg`} alt="Ile d'Oléron" />
          <img className="stop__img stop__img--right" src={`${import.meta.env.BASE_URL}images/Clip2Comic-Oleron.jpeg`} alt="Ile d'Oléron" />
      ...
      <TripStop id="PevnostBoyard" title="Pevnost Boyard" color={true}>
        <div className="stop__text-picture">
          <img className="stop__img stop__img--right" src={`${import.meta.env.BASE_URL}images/Clip2Comic-Boyard.jpeg`} alt="Pevnost Boyard" />
      ...
      <TripStop id="Saumur" title="Saumur" color={false}>
        <div className="stop__text-picture">
          <img className="stop__img stop__img--left" style={{maxWidth: '320px'}} src={`${import.meta.env.BASE_URL}images/Clip2Comic-Saumur.jpeg`} alt="Saumur" />
      ...
      <TripStop id="SullySurLoire" title="Sully-sur-Loire" color={true}>
        <div className="stop__text-picture">
          <img className="stop__img stop__img--left" src={`${import.meta.env.BASE_URL}images/Clip2Comic-ChateauSully.jpeg`} alt="Château de Sully-sur-Loire" />
          <img className="stop__img stop__img--right" src={`${import.meta.env.BASE_URL}images/Clip2Comic-SullySurLoire.jpeg`} alt="Sully-sur-Loire" />
      ...
      <TripStop id="Legoland" title="Legoland" color={false}>
        <div className="stop__text-picture">
          <img className="stop__img stop__img--left" src={`${import.meta.env.BASE_URL}images/Clip2Comic-Legoland.jpeg`} alt="Legoland" />
